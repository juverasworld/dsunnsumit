...
const Footer: React.FC = () => {
  return (
    <footer className="my-16 border-0 flex container mx-auto">
      <div className="flex xl:flex-row  flex-col items-center xl:justify-evenly justify-start">
        ...
        <div className="flex xl:flex-row flex-col w-full justify-evenly  mx-0 border-2">
